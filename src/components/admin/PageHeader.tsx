...
export function PageHeader({
  ...
  return (
    <header className="sticky top-0 z-[5] flex items-center justify-between gap-4 border-b border-[var(--cat-border)] bg-white/85 px-5 py-3.5 backdrop-blur-xl sm:px-8">
