...
-- New Supabase projects do not grant public-schema access by default.
-- Without this, the secret key authenticates but PostgREST returns
-- 42501 "permission denied for schema public" and sign-up cannot
...
-- ---------------------------------------------------------------------------
-- Additive: merchandising (featured, banners, footer, image fit).
-- Existing projects can run supabase/merchandising.sql once instead.
-- ---------------------------------------------------------------------------
alter table catalog_items
